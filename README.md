...
# 👋 Hello there! I'm **shanks**

<img src="https://user-images.githubusercontent.com/115834477/dbab4500-a447-11eb-908a-139a6edaec5c.gif" width="420"/>
...
Building **distributed systems**, **event-driven backends**, and **AI-assisted developer tools** that make complex workflows feel simple.

### 💹 What I care about

Turning messy infrastructure into clean pipelines.  
...
def ship(system):
    make_it_work(system)
    make_it_observable(system)
    make_failure_boring(system)
    automate_the_pain(system)
    return simpler_than_yesterday
```
